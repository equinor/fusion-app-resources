...
describe('Contract Detail', () => {
  ...
  it('TC 13034 Contract Detail', () => {
    ...
    navigationDrawer.GeneralTab().invoke('attr', 'class').should('contain', 'isActive')
    ...
    contractDetail.EquinorRespDelegateTable().should('be.visible')
    ...
    contractDetail.ExternalRespDelegateTable().should('be.exist')
