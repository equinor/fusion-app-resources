...
export declare enum ApplicationGuideEventType {
...
export declare type ApplicationGuideEventDetail = {
    selected?: {
        scope: string;
        anchor: string;
    };
...
export declare class ApplicationGuideEvent<T extends ApplicationGuideEventType | unknown = unknown> extends CustomEvent<ApplicationGuideEventDetail> {
