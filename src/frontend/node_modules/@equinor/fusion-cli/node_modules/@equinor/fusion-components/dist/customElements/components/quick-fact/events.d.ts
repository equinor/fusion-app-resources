...
export declare enum QuickFactEventType {
...
export declare type QuickFactEventDetail = {
    anchor?: string;
    scope?: string;
    info?: QuickFact;
    view?: ViewMode;
};
export declare class QuickFactEvent<T extends QuickFactEventType> extends CustomEvent<QuickFactEventDetail> {
