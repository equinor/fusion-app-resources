...
export declare type UseAnchorProps<R extends HTMLElement = HTMLElement> = Omit<AppGuideAnchorRef<R>, 'ref'>;
/**
 * @see useAnchorRef
 *
 ...
 * @returns [ useRef<R>]
 */
export declare const useAnchor: <R extends HTMLElement>(anchor: UseAnchorProps<R>) => import("react").MutableRefObject<R>;
/**
 *
