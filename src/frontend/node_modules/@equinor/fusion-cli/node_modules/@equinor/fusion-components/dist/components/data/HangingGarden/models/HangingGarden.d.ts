...
export declare type HangingGardenColumn<T> = {
    key: string;
    data: T[];
};
export declare type HangingGardenColumnIndex = Record<string, any>;
export declare type GardenController = {
    clearGarden: () => void;
};
export declare type HangingGardenProps<T extends HangingGardenColumnIndex> = {
