...
export default class AppContainer extends EventEmitter {
    ...
    addOrUpdate(apps) {
        if (compareApps(this.apps.state, apps)) {
            ...
            this.apps.state = Object.freeze(Object.assign(Object.assign({}, this.apps.state), nextState));
        }
    }
    async getConfigAsync(tag, cancellationToken) {
        var _a;
        const appKey = (_a = this._currentApp.state) === null || _a === void 0 ? void 0 : _a.key;
        const tagCacheKey = `${appKey}-${tag !== null && tag !== void 0 ? tag : 'default'}`;
        ...
        // Fetch from store
        const getConfigUrl = (appKey, tag = null) => {
        ...
        const resp = await this.fusionClient.getAsync(getConfigUrl(appKey, tag), {
