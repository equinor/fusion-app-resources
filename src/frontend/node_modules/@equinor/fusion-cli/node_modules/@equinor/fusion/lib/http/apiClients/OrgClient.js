...
export default class OrgClient extends BaseApiClient {
    ...
    async deleteProjectImageAsync(projectId) {
        const orgResources = this.resourceCollections.org;
        const url = orgResources.projectImage(projectId);
        const requestHeader = {
            headers: {
    ...
    async getPositionsAllowHeaders(projectId, draftId) {
        const orgResources = this.resourceCollections.org;
        const url = draftId
    ...
    async getPositionReportPathAsync(projectId, positionId, instanceId, snapshotId) {
        const orgResources = this.resourceCollections.org;
        const url = snapshotId
    ...
    async getPositionAllowHeaders(projectId, positionId, draftId) {
        const orgResources = this.resourceCollections.org;
        const url = draftId
