...
export default class OrgClient extends BaseApiClient {
    ...
    deleteProjectImageAsync(projectId: string): Promise<HttpResponse<void>>;
    getPositionsAsync(projectId: string, expandProperties?: string[], snapshotId?: string): Promise<HttpResponse<Position[]>>;
    getPositionsAllowHeaders(projectId: string, draftId?: string): Promise<string | null>;
    ...
    getPositionReportPathAsync(projectId: string, positionId: string, instanceId: string, snapshotId?: string): Promise<HttpResponse<PositionReportPath>>;
    ...
    getPositionAllowHeaders(projectId: string, positionId: string, draftId?: string): Promise<string | null>;
