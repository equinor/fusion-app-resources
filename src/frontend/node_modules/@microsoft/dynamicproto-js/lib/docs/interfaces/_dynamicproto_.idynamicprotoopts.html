...
<head>
	...
	<title>IDynamicProtoOpts | @microsoft/dynamicproto-js</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-parent-kind-external-module">
			<a href="_dynamicproto_.idynamicprotoopts.html" class="tsd-kind-icon">IDynamic<wbr>Proto<wbr>Opts</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="_dynamicproto_.idynamicprotoopts.html#setinstfuncs" class="tsd-kind-icon">set<wbr>Inst<wbr>Funcs</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="_dynamicproto_.idynamicprotoopts.html#usebaseinst" class="tsd-kind-icon">use<wbr>Base<wbr>Inst</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter">
			<a href="../modules/_dynamicproto_.html#dynamicprotodelegate" class="tsd-kind-icon">Dynamic<wbr>Proto<wbr>Delegate</a>
		</li>
		<li class=" tsd-kind-variable tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="../modules/_dynamicproto_.html#dynallowinstchktag" class="tsd-kind-icon">Dyn<wbr>Allow<wbr>Inst<wbr>Chk<wbr>Tag</a>
		</li>
		<li class=" tsd-kind-variable tsd-parent-kind-external-module tsd-is-not-exported">
		...
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="../modules/_dynamicproto_.html#_getprotofunc" class="tsd-kind-icon">_get<wbr>Proto<wbr>Func</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="../modules/_dynamicproto_.html#_hasvisited" class="tsd-kind-icon">_has<wbr>Visited</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter">
			<a href="../modules/_dynamicproto_.html#dynamicproto" class="tsd-kind-icon">dynamic<wbr>Proto</a>
		</li>
		<li class=" tsd-kind-object-literal tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="../modules/_dynamicproto_.html#perfdefaults" class="tsd-kind-icon">perf<wbr>Defaults</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Interface to define additional configuration options to control how the dynamic prototype functions operate.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">IDynamicProtoOpts</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="_dynamicproto_.idynamicprotoopts.html#setinstfuncs" class="tsd-kind-icon">set<wbr>Inst<wbr>Funcs</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="_dynamicproto_.idynamicprotoopts.html#usebaseinst" class="tsd-kind-icon">use<wbr>Base<wbr>Inst</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="setinstfuncs" class="tsd-anchor"></a>
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/microsoft/DynamicProto-JS/blob/67be424/lib/src/DynamicProto.ts#L437">DynamicProto.ts:437</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Should the dynamic prototype attempt to set an instance function for instances that do not already have an
						function of the same name or have been extended by a class with a (non-dynamic proto) prototype function.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="usebaseinst" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> use<wbr>Base<wbr>Inst</h3>
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/microsoft/DynamicProto-JS/blob/67be424/lib/src/DynamicProto.ts#L443">DynamicProto.ts:443</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>When looking for base (super) functions if it finds a dynamic proto instances can it use the instance functions
