...
<head>
	...
	<title>@microsoft/dynamicproto-js | @microsoft/dynamicproto-js</title>
...
<span class="hljs-keyword">class</span> ExampleClass <span class="hljs-keyword">extends</span> BaseClass {
 ...
 npm install -g @microsoft/rush</code></pre>
				</li>
				<li><p>Navigate to the root folder and update rush dependencies</p>
					<pre><code class="language-sh"> rush update</code></pre>
				</li>
 ...
 npm run <span class="hljs-built_in">test</span></code></pre>
    ...
    NormalClass.prototype.function1 = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-comment">//...</span>
        doSomething();
    };
    NormalClass.prototype.function2 = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-comment">//...</span>
        doSomething();
    };
    NormalClass.prototype.function3 = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-comment">//...</span>
        doSomething();
    };
    <span class="hljs-keyword">return</span> NormalClass;
			...
			<pre><code class="language-JavaScript"><span class="hljs-keyword">var</span> NormalClass=(NormalClass.prototype.function1=<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>)</span>{doSomething()},NormalClass.prototype.function2=<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>)</span>{doSomething()},NormalClass.prototype.function3=<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>)</span>{doSomething()},<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>)</span>{<span class="hljs-keyword">this</span>.property1=[],<span class="hljs-keyword">this</span>.property1.push(<span class="hljs-string">"Hello"</span>)});</code></pre>
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">DynamicClass</span>(<span class="hljs-params"></span>) </span>{
        dynamicProto(DynamicClass, <span class="hljs-keyword">this</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">_self, base</span>) </span>{
            ...
            _self.function2 = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
                <span class="hljs-comment">//...</span>
                doSomething();
            };
            _self.function3 = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
                <span class="hljs-comment">//...</span>
                doSomething();
            };
        });
    ...
    <span class="hljs-keyword">return</span> DynamicClass;
			...
			<p>You can disable this default behavior by passing a new (optional) 4th argument to the dynamicProto(), the new &#39;options&#39; argument is defined as an interface IDynamicProtoOpts to aid with any future options that may get exposed and has the following values
				| Name | Type | Description
				|------|------|-------------
			| setInstFuncs | Boolean | Should the dynamic prototype attempt to set an instance function for instances that do not already have an function of the same name or have been extended by a class with a (non-dynamic proto) prototype function.</p>
			<blockquote>
				<p>Note:</p>
			...
			<p>1) When you attempt to extend a base class which defines an abstract member (class) function you will get
				<code>error TS2424: Class &#39;ABC&#39; defines instance member function &#39;myFunction&#39;, but extended class &#39;XYZ&#39; defines it as instance member property.</code>
			* The only solution for this is to define an empty &#39;Stub&#39; method which stops the error, but also generates an unused prototype method in your final code that just takes up space.</p>
			<pre><code class="language-typescript"><span class="hljs-keyword">export</span> <span class="hljs-keyword">abstract</span> <span class="hljs-keyword">class</span> ABC {
    <span class="hljs-keyword">public</span> myFunction(someArg:<span class="hljs-built_in">string</span>): <span class="hljs-built_in">void</span> {
    }

    <span class="hljs-keyword">public</span> <span class="hljs-keyword">abstract</span> myFunction2(theArg:<span class="hljs-built_in">string</span>, ...): <span class="hljs-built_in">void</span>;
}

<span class="hljs-keyword">export</span> <span class="hljs-keyword">class</span> XYZ <span class="hljs-keyword">extends</span> ABC {
    <span class="hljs-keyword">public</span> myFunction2(theArg:<span class="hljs-built_in">string</span>, ...): <span class="hljs-built_in">void</span> {
        <span class="hljs-comment">// This stub is required otherwise it won't compile</span>
        <span class="hljs-comment">// It's also extra unnecessary code in the final code</span>
    }

    <span class="hljs-keyword">constructor</span>(<span class="hljs-params"></span>) {
        dynamicProto(XYZ, <span class="hljs-keyword">this</span>, <span class="hljs-function">(<span class="hljs-params">self, base</span>) =&gt;</span> {
            self.myFunction = <span class="hljs-function">(<span class="hljs-params">someArg</span>) =&gt;</span> {
                <span class="hljs-comment">// This implements a member function (on the prototype)</span>
            };

            self.myFunction2 = <span class="hljs-function">(<span class="hljs-params">theArg:<span class="hljs-built_in">string</span>, ...</span>) =&gt;</span> {
            };
        });
    }
}</code></pre>
			...
			<pre><code class="language-javascript"><span class="hljs-keyword">var</span> XYZ = <span class="hljs-comment">/** @class */</span> (<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">XYZ</span>(<span class="hljs-params"></span>) </span>{
        dynamicProto(XYZ, <span class="hljs-keyword">this</span>, (self, base) =&gt; {
            <span class="hljs-comment">// ... Removed for brevity ...</span>
            self.myFunction2 = <span class="hljs-function">(<span class="hljs-params">theArg:string, ...</span>) =&gt;</span> {
            };
        });
    }
    XYZ.prototype.myFunction2 = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-comment">// This stub is required otherwise it won't compile</span>
        <span class="hljs-comment">// It's also extra unnecessary code in the final code</span>
    };
    <span class="hljs-keyword">return</span> XYZ;
}());</code></pre>
			<p>2) When you are creating a class that you want users to be able to extend (using TypeScript), and you want all of the functions to be declared (in the *.d.ts) as member functions (not properties), so that the extendsion classes (using typescript) can just use the normal <code>super</code> keyword without forcing them to either use dynamicProto() or save / call the instance properties.
			* As with above the only solution (for dynamically generated declaration files) would be to defined Stub methods as above.</p>
			<pre><code class="language-typescript"><span class="hljs-keyword">export</span> <span class="hljs-keyword">class</span> BaseClass {
    <span class="hljs-comment">// A Member function</span>
    <span class="hljs-keyword">public</span> myFunction(someArg:<span class="hljs-built_in">string</span>):<span class="hljs-built_in">void</span> { 
        <span class="hljs-comment">// Stub function</span>
    }

    <span class="hljs-comment">// A instance member property (which happens to be a function)</span>
    <span class="hljs-keyword">public</span> propFunction: <span class="hljs-function">(<span class="hljs-params">theArgs:<span class="hljs-built_in">string</span></span>) =&gt;</span> <span class="hljs-built_in">void</span>;

    <span class="hljs-keyword">constructor</span>(<span class="hljs-params"></span>) {
        dynamicProto(BaseClass, <span class="hljs-keyword">this</span>) (self) =&gt; {
            <span class="hljs-comment">// This will create (at runtime) a member functions</span>
            self.myFunction = <span class="hljs-function">(<span class="hljs-params">someArg:<span class="hljs-built_in">string</span></span>) =&gt;</span> {
            };
            self.propFunction = <span class="hljs-function">(<span class="hljs-params">theArgs:<span class="hljs-built_in">string</span></span>) =&gt;</span> {
            };
        });
    }
}

<span class="hljs-keyword">export</span> <span class="hljs-keyword">class</span> NewClass <span class="hljs-keyword">extends</span> BaseClass {
    <span class="hljs-comment">// This works as TS see's that the base class has a prototype</span>
    <span class="hljs-comment">// function (not a property one)</span>
    <span class="hljs-keyword">public</span> myFunction(someArg:<span class="hljs-built_in">string</span>:<span class="hljs-built_in">void</span>) {
        <span class="hljs-keyword">super</span>.myFunction(someArg);
    }

    <span class="hljs-keyword">public</span> propFunction(theArgs:<span class="hljs-built_in">string</span>): <span class="hljs-built_in">void</span> {
        <span class="hljs-comment">// This doesn't work as you can't call super on properties</span>
        <span class="hljs-comment">// Even though, when the base class is using dynamicProto()</span>
        <span class="hljs-comment">// this WILL work!</span>
        <span class="hljs-keyword">super</span>.propFunction(theArgs);
    }
}</code></pre>
			...
			<ul>
				<li><p>The function must be a instance member function (a prototype level function) where the generated JS looks like &quot;<code>MyClass.prototype.methodName = function () { };</code>&quot;</p>
				</li>
				<li><p>The <code>tagname</code> must appear either on the line before the function name (pre); on the closing line of the function (post) (NOTE: Not after as TypeScript can drop this from the final output) or within the stub function (enclosed).</p>
					<pre><code>  // @<span class="hljs-type">DynamicProtoStub</span>
  <span class="hljs-type">MyClass</span>.proto<span class="hljs-keyword">type</span>.methodName = function () {
  };

  <span class="hljs-type">MyClass</span>.proto<span class="hljs-keyword">type</span>.methodName = function () {
  }; // @<span class="hljs-type">DymanicProtoStub</span>

  <span class="hljs-type">MyClass</span>.proto<span class="hljs-keyword">type</span>.methodName = function () {
      // @<span class="hljs-type">DynamicProtoStub</span>
  };

  <span class="hljs-type">MyClass</span>.proto<span class="hljs-keyword">type</span>.methodName = function () {
      /* @<span class="hljs-type">DynamicProtoStub</span> 
      * <span class="hljs-type">Some</span> other comments
      */
  };</code></pre></li>
				<li><p>The pre and post tagging comments must be defined using a single line comment &quot;<code>// @DynamicProtoStub</code>&quot; only.</p>
				</li>
				<li><p>Enclosed tagging comments (within the function definition) may be defined using either single or multi-line comments. But the tagging comment MUST be the first comment within the function.</p>
				</li>
				<li><p>The function <em>may</em> be prefixed by a typedoc comment of &quot;<code>/** Description @param arg - arg details */</code>&quot; etc, which will be removed if the function is removed. However, it will not remove other prefixed single or multi-line comments.</p>
				</li>
				<li><p>The <code>tagname</code> must be the first &quot;element&quot;/&quot;word&quot; of any comment with optional leading spaces or tabs only. </p>
					<ul>
						<li>e.g. These would not match &quot;<code>// - @DynamicProtoStub</code>&quot;, &quot;<code>// This is the @DynamicProtoStub</code>&quot;</li>
					</ul>
				</li>
				<li><p>Tagging comments may contains additional trailing content (after the tagName) and will also be removed</p>
					<ul>
						<li>&quot;<code>// @DynamicProtoStub - Will be removed!</code>&quot;</li>
					</ul>
				</li>
				<li><p>If the stub function appears to contain any logic, specifically a closing bracket <code>}</code> (including with a comment) will cause the function to not be matched and removed.</p>
				</li>
				<li><p>A final check is performed after removing all tagged functions for any remaining tags within the result and if any tags are detected it will cause the removal process to throw and fail the conversion. This ensures that if you expected a function to be removed that it has been removed.</p>
					<ul>
 ...
 */</span>
<span class="hljs-comment">// @DynamicProtoStub</span>
<span class="hljs-keyword">public</span> toBeRemoved():<span class="hljs-built_in">void</span> {
}
 ...
 */</span>
<span class="hljs-keyword">public</span> myFunction(args:<span class="hljs-built_in">string</span>): <span class="hljs-built_in">void</span> {
    ...
} <span class="hljs-comment">// @DynamicProtoStub - Function will be removed</span>

<span class="hljs-keyword">public</span> myFunction2(): <span class="hljs-built_in">void</span> {
...
}  <span class="hljs-comment">// @DynamicProtoStub - Function will be removed</span>
...
<span class="hljs-keyword">public</span> myFunction2(): <span class="hljs-built_in">void</span> {
    <span class="hljs-comment">/* @DynamicProtoStub 
...
<span class="hljs-keyword">public</span> myFunction3(): <span class="hljs-built_in">void</span> {
}
<span class="hljs-comment">// @DynamicProtoStub - This method will not be removed</span>


<span class="hljs-comment">// @DynamicProtoStub - This method will not be removed</span>

<span class="hljs-keyword">public</span> myFunction4(): <span class="hljs-built_in">void</span> {
}
...
<span class="hljs-keyword">public</span> myFunction4(): <span class="hljs-built_in">void</span> {
    <span class="hljs-comment">// This is a stub</span>
    <span class="hljs-comment">/* @DynamicProtoStub 
     ...
     */</span>
			...
			<pre><code class="language-javascript"><span class="hljs-keyword">import</span> dynamicRemove <span class="hljs-keyword">from</span> <span class="hljs-string">"@microsoft/dynamicproto-js/tools/rollup/node/removedynamic"</span>;

  <span class="hljs-keyword">const</span> moduleRollupConfig = {
    <span class="hljs-attr">input</span>: <span class="hljs-string">`<span class="hljs-subst">${inputName}</span>.js`</span>,
    <span class="hljs-attr">output</span>: {
      <span class="hljs-attr">file</span>: <span class="hljs-string">`./dist/<span class="hljs-subst">${format}</span>/<span class="hljs-subst">${outputName}</span>.js`</span>,
      <span class="hljs-attr">banner</span>: banner,
      <span class="hljs-attr">format</span>: format,
        <span class="hljs-attr">name</span>: <span class="hljs-string">"OutputName-JS"</span>,
      <span class="hljs-attr">extend</span>: <span class="hljs-literal">true</span>,
      <span class="hljs-attr">sourcemap</span>: <span class="hljs-literal">true</span>
    },
    <span class="hljs-attr">plugins</span>: [
      dynamicRemove(),
      dynamicRemove({ <span class="hljs-attr">tagname</span>: <span class="hljs-string">"@MyTagName"</span> }),
      nodeResolve(),
      uglify({
        ...
        <span class="hljs-attr">compress</span>: {
          <span class="hljs-attr">passes</span>:<span class="hljs-number">3</span>,
          <span class="hljs-attr">unsafe</span>: <span class="hljs-literal">true</span>
        },
        <span class="hljs-attr">output</span>: {
          <span class="hljs-attr">preamble</span>: banner,
          <span class="hljs-attr">webkit</span>:<span class="hljs-literal">true</span>
        }
      })
    ]
  };
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-external-module"><a href="modules/_dynamicproto_.html" class="tsd-kind-icon">&quot;<wbr>Dynamic<wbr>Proto&quot;</a></li>
						</ul>
					</section>
				</div>
			</section>
