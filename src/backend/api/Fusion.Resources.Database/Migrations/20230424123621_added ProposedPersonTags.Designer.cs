...
namespace Fusion.Resources.Database.Migrations
{
    ...
    [Migration("20230424123621_added ProposedPersonTags")]
    partial class addedProposedPersonTags
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fusion.Resources.Database.Entities.DbDelegatedDepartmentResponsible", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DelegatedDepartmentResponsibles");
                });

            modelBuilder.Entity("Fusion.Resources.Database.Entities.DbDelegatedDepartmentResponsibleHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fusion.Resources.Database.Entities.DbPersonNote", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("AzureUniqueId"), false);
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("AzureUniqueId"), new[] { "Id", "Title", "Content", "IsShared", "Updated", "UpdatedById" });
            ...
            modelBuilder.Entity("Fusion.Resources.Database.Entities.DbRequestComment", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("RequestId"), false);
            ...
            modelBuilder.Entity("Fusion.Resources.Database.Entities.DbResourceAllocationRequest", b =>
                {
                    ...
                    b.Property<string>("ProposedPersonTags")
                        .HasColumnType("nvarchar(max)");
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("RequestNumber"), 1L, 1);
            ...
            modelBuilder.Entity("Fusion.Resources.Database.Entities.DbSecondOpinionResponse", b =>
                {
                    ...
                    b.ToTable("SecondOpinionResponses", (string)null);
                });
            ...
            modelBuilder.Entity("DbPersonDbResourceAllocationRequest", b =>
                {
                    ...
                    b.HasOne("Fusion.Resources.Database.Entities.DbPerson", null)
                        .WithMany()
