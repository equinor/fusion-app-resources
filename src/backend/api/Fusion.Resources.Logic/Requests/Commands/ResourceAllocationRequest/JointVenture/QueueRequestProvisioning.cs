    ...
    public partial class ResourceAllocationRequest
    {
        ...
        public partial class JointVenture
        {
            internal class QueueRequestProvisioning : IRequest
            {
                ...
                public static QueueRequestProvisioning InternalPersonnelRequest(Guid requestId, Guid orgProjectId) => new QueueRequestProvisioning(RequestType.InternalPersonnel, requestId, orgProjectId);
                ...
                public class Handler : AsyncRequestHandler<QueueRequestProvisioning>
                {
                        ...
                        CancellationToken cancellationToken)
                    {
                        await queueSender.SendMessageAsync(QueuePath.ProvisionPosition, new ProvisionPositionMessageV1
                        {
                            ...
                            {
                                RequestType.InternalPersonnel => ProvisionPositionMessageV1.RequestTypeV1.InternalPersonnel,
