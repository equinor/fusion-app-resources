...
namespace Fusion.Resources.Domain.Commands
{
    ...
    /// </summary>
    public class UpdatePosition : TrackableRequest<ApiPositionV2>
    {
        public UpdatePosition(ApiPositionV2 position)
        {
        ...
        public UpdatePosition(Guid projectId, Guid positionId)
        {
        ...
        public class Handler : IRequestHandler<UpdatePosition, ApiPositionV2>
        {
            ...
            public async Task<ApiPositionV2> Handle(UpdatePosition request, CancellationToken cancellationToken)
            {
