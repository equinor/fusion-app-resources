...
namespace Fusion.Resources.Api.Controllers
{
    ...
    public class InternalRequestsController : ResourceControllerBase
    {
        ...
        public async Task<ActionResult<ApiResourceAllocationRequest>> CreateProjectAllocationRequest(
            [FromRoute] ApiProjectIdentifier projectIdentifier, [FromBody] CreateResourceAllocationRequest request)
        {
        ...
        public async Task<ActionResult<ApiCollection<ApiResourceAllocationRequest>>> GetResourceAllocationRequestsForProject(
            [FromRoute] ApiProjectIdentifier projectIdentifier, [FromQuery] ODataQueryParams query)
        {
            #region Authorization
        ...
        public async Task<ActionResult<ApiResourceAllocationRequest>> StartProjectRequestWorkflow([FromRoute] ApiProjectIdentifier projectIdentifier, Guid requestId)
        {
        ...
        public async Task<ActionResult<ApiResourceAllocationRequest>> ApproveProjectAllocationRequest([FromRoute] ApiProjectIdentifier projectIdentifier, Guid requestId)
        {
            var result = await DispatchAsync(new GetResourceAllocationRequestItem(requestId));
        ...
        public async Task<ActionResult<ApiResourceAllocationRequest>> CheckApprovalAccess([FromRoute] ApiProjectIdentifier projectIdentifier, Guid requestId)
        {
            var result = await DispatchAsync(new GetResourceAllocationRequestItem(requestId));
        ...
        public async Task<ActionResult> CheckProjectAllocationRequestAccess([FromRoute] ApiProjectIdentifier projectIdentifier, Guid requestId)
        {
        ...
        public async Task<ActionResult> CheckInstanceRequestTypeAsync([FromRoute] ApiProjectIdentifier projectIdentifier, Guid positionId, Guid instanceId, [FromQuery] string? requestType)
        {
        ...
        public async Task<ActionResult<ApiCollection<ApiResourceAllocationRequest>>> GetResourceAllocationRequestsOptions(
            [FromRoute] ApiProjectIdentifier projectIdentifier, [FromRoute] string? departmentPath)
        {
            var allowedVerbs = new List<string>();
