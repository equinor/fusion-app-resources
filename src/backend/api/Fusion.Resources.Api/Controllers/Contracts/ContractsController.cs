...
namespace Fusion.Resources.Api.Controllers
{
    ...
    public class ContractsController : ResourceControllerBase
    {
        ...
        public async Task<ActionResult<ApiCollection<ApiContract>>> GetProjectAllocatedContract([FromRoute]PathProjectIdentifier projectIdentifier)
        {
        ...
        public async Task<ActionResult<ApiContract>> GetProjectContract([FromRoute]PathProjectIdentifier projectIdentifier, Guid contractId)
        {
        ...
        public async Task<ActionResult<ApiContract>> AllocateProjectContract([FromRoute]PathProjectIdentifier projectIdentifier, [FromBody] ContractRequest request)
        {
            #region Authorization
        ...
        public async Task<ActionResult<ApiContract>> UpdateProjectContract([FromRoute]PathProjectIdentifier projectIdentifier, Guid contractIdentifier, [FromBody] ContractRequest request)
        {
            #region Authorization
        ...
        public async Task<ActionResult<ApiClients.Org.ApiPositionV2>> EnsureContractExternalCompanyRep([FromRoute]PathProjectIdentifier projectIdentifier, Guid contractIdentifier, [FromBody] ContractPositionRequest request)
        {
            #region Authorization
        ...
        public async Task<ActionResult<ApiClients.Org.ApiPositionV2>> EnsureContractExternalContractResp([FromRoute]PathProjectIdentifier projectIdentifier, Guid contractIdentifier, [FromBody] ContractPositionRequest request)
        {
            #region Authorization
        ...
        public async Task<ActionResult<List<ApiDelegatedRole>>> GetContractDelegatedRoles([FromRoute] PathProjectIdentifier projectIdentifier, Guid contractIdentifier)
        {
            // Not sure if there is any restrictions on listing contracts for a project.
            #region Authorization
        ...
        public async Task<ActionResult<ApiDelegatedRole>> CreateContractDelegatedRole([FromRoute] PathProjectIdentifier projectIdentifier, Guid contractIdentifier, [FromBody] CreateDelegatedRoleRequest request)
        {
        ...
        public async Task<ActionResult> DeleteContractDelegatedRole([FromRoute] PathProjectIdentifier projectIdentifier, Guid contractIdentifier, Guid roleId)
        {
        ...
        public async Task<ActionResult<ApiDelegatedRole>> UpdateContractDelegatedRole([FromRoute] PathProjectIdentifier projectIdentifier, Guid contractIdentifier, Guid roleId, [FromBody] PatchDelegatedRoleRequest request)
        {
            var role = await DispatchAsync(new GetContractDelegatedRole(roleId));
        ...
        public async Task<ActionResult> CheckContractDelegationAccess([FromRoute] PathProjectIdentifier projectIdentifier, Guid contractIdentifier, [FromQuery] string classification)
        {
