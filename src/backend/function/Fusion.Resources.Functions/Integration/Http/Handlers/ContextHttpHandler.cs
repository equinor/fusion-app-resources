...
namespace Fusion.Resources.Functions.Integration.Http.Handlers
{
    public class ContextHttpHandler : FunctionHttpMessageHandler
    {
        ...
        public ContextHttpHandler(ILoggerFactory loggerFactory, ITokenProvider tokenProvider, IServiceDiscovery serviceDiscovery, IOptions<HttpClientsOptions> options)
