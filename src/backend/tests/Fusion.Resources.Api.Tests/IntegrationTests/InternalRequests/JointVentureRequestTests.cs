...
namespace Fusion.Resources.Api.Tests.IntegrationTests
{
    ...
    public class JointVentureRequestTests : IClassFixture<ResourceApiFixture>, IAsyncLifetime
    {
        ...
        public JointVentureRequestTests(ResourceApiFixture fixture, ITestOutputHelper output)
        {
        ...
        #region Start
        [Fact]
        public async Task JVRequest_Start_ShouldBeBadRequest_WhenNoPersonProposed()
        {
        ...
        [Fact]
        public async Task JVRequest_Start_ShouldBeSuccessfull_WhenPersonIsProposed()
        {
            using var adminScope = fixture.AdminScope();
        ...
        public async Task JVRequest_Start_ShouldSet(string property, object value)
        {
            ...
            await FastForward_StartJointVentureRequestAsync();
        ...
        [Fact]
        public async Task JVRequest_Start_ShouldAddWorkflowInfo_WhenStartingRequest()
        {
            using var adminScope = fixture.AdminScope();
